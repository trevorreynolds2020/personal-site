...
import "./home.css"
import ProjectsContainer from './work/ProjectsContainer';
                ...
                {/* { homeSections
                    ...
                    .map( section =>
                        <div key={section.name} ref={section.name}>
                            { section.name === "code" ? <section.component onShowProjectDetails={() => this.scrollToSection("work")} /> : <section.component /> }
                        </div> 
                    )
                } */}
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(HomeCopy));